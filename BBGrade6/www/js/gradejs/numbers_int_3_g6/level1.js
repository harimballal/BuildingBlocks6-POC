Game.numbers_int_3_g6l1=function(){};


Game.numbers_int_3_g6l1.prototype ={
    ...
    init:function(game)
    {
       ...
       //telInitializer.gameIdInit("sequence2_1_1a",gradeSelected);
        ...
        _this.src_1.setAttribute("src", "questionSounds/numbers_int_3_g6/English/question2.1.mp3");
        ...
        _this.src_2.setAttribute("src", "questionSounds/numbers_int_3_g6/English/question2.3.mp3");
    ...
    getQuestion:function(target)
    {
        ...
        _this.initialTween2 = _this.add.tween(_this.KF_initialsitting).to( { alpha: 1 }, 3000, 'Linear', false, 0);
   ...
   Initial_Hovering_Fn: function()
   {
       //remove sitting bird and show hovering bird for 2 seconds.
        ...
        //make the bird hover for 2 seconds
        _this.initialTween1 = _this.add.tween(_this.initial_hovering).to( {  x: 480, y:230 }, 2000, 'Quart', false, 0);
    ...
    { 
        ...
        _this.initialTween3.to({x: 1100, y: 200 }, 1500, 'Linear', false, 0);
       ...
       //highlight the number scale when the bird just crosses it.
        ...
        _this.scale.animations.play('level_scale',15, true);
    ...
    tween_1AComplete: function(target){
        ...
        _this.tween_1B.to({Angle: 220, x: 180, y: 280 }, 1000, 'Linear', false, 0);
    ...
    tween_1BComplete: function(target){
        ...
        _this.tween_1C.to({Angle: 220, x: 75, y: 250 }, 1000, 'Linear', false, 0);
...
//based on the current option, fade and destroy the objects on screen
       ...
       if (_this.thirdQOption == 1){
           ...
           _this.KF_fadeOut3 = _this.add.tween(_this.Kingfisher_hovering).to( { alpha: 0 }, 4500, 'Linear', true, 0);
           ...
           _this.KF_fadeOut1 = _this.add.tween(_this.Kingfisher_yoyo).to( { alpha: 0 }, 3000, 'Linear', true, 0);
           ...
           _this.KF_fadeOut2 = _this.add.tween(_this.KF_Eatingfish).to( { alpha: 0 }, 3000, 'Linear', true, 0);
...
// most of the objects are destroyed since they are added to obj group and num group to get ready for next question. Max 6 questions.
            ...
            else
            {
                ...
                _this.timer1.stop();
                _this.timer1=null;
                _this.state.start('numbers_int_3_g6Score');
...
Q3_rightbtnClicked:function(target){
         ...
         { 
            ...
            {
                _this.time.events.add(5000, _this.Q3_ClearObjects);
            }
            else
            {
