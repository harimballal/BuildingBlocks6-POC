Game.numbers_int_4_g6l1=function(){};


Game.numbers_int_4_g6l1.prototype ={
	...
	create:function(game){
        ...
        _this.fish_1 =_this.add.sprite('Fish_1');
...
//        //_this.Bowlplace.animations.play('Fishbowl', 15, true);
  ...
  //  _this.graphics1.lineTo(200, 500);
    ...
    Q4_askQ4VoiceQuestionProcess: function(){
        ...
        if(_this.Q4_Options == 1)
        ...
        else if(_this.Q4_Options == 2)
         {
            ...
            _this.getVoice();
            _this.time.events.add(2000, _this.getVoice3);        
    ...
    getVoice2:function()
    {
        ...
        {
            case 0: _this.src.setAttribute("src", "questionSounds/numbers_int_4_g6/English/zero.mp3");
                    break;
            case 1: _this.src.setAttribute("src", "questionSounds/numbers_int_4_g6/English/plus-one.mp3");
                        break; 
            case 2: _this.src.setAttribute("src", "questionSounds/numbers_int_4_g6/English/plus-two.mp3");
                        break;
            case 3: _this.src.setAttribute("src", "questionSounds/numbers_int_4_g6/English/plus-three.mp3");
                        break;
            case 4: _this.src.setAttribute("src", "questionSounds/numbers_int_4_g6/English/plus-four.mp3");
                        break;
            case 5: _this.src.setAttribute("src", "questionSounds/numbers_int_4_g6/English/plus-five.mp3");
                        break;
        }
        
        _this.playQuestionSound1.appendChild(_this.src);
        _this.playQuestionSound1.play();
    ...
    getVoice3:function()
    {
        ...
        switch(_this.Q4_fishQn)
        {
            ...
            case -1: _this.src.setAttribute("src", "questionSounds/numbers_int_4_g6/English/minus-one.mp3");
                        break; 
            case -2: _this.src.setAttribute("src", "questionSounds/numbers_int_4_g6/English/minus-two.mp3");
                        break;
            case -3: _this.src.setAttribute("src", "questionSounds/numbers_int_4_g6/English/minus-three.mp3");
                        break;
            case -4: _this.src.setAttribute("src", "questionSounds/numbers_int_4_g6/English/minus-four.mp3");
                        break;
            case -5: _this.src.setAttribute("src", "questionSounds/numbers_int_4_g6/English/minus-five.mp3");
                        break;
         }
    ...
    Q4_eraseScreen: function(){
        ...
        if(_this.reset==1 || _this.reset==3){
                ...
                _this.Fish_place.x = _this.fish_1.x;
                _this.Fish_place.y = _this.fish_1.y;
        ...
        if(_this.Q4_KFQn ==  0||_this.Q4_KFQn ==  1 || _this.Q4_KFQn ==  2 || _this.Q4_KFQn ==  3 || _this.Q4_KFQn ==  4 || _this.Q4_KFQn ==  5)
        {
            if(_this.Q4_KFQn ==  _this.rightAns)
            ...
            else
             {
               ...
               _this.shake.shake(10, _this.KFsitting);
               _this.reset=3;
    ...
    Q4_Fishvalidation: function(target){
        
        if (_this.rightbtnClicked == false)
        {
            _this.rightbtnClicked = true;
            _this.Q4_FishvalidationProcess(target);
            //console.log("Rightbtn clicked made false after validation");
            //_this.rightbtnClicked = false;
        }
    },
            ...
            if(_this.Q4_fishQn ==  _this.rightAns)
             {
               ...
               _this.starActions();
                ...
                _this.time.events.add(5500, _this.Q4_gotonext);
            ...
            else
             {
               ...
               _this.time.events.add(1000, function(){
                   ...
                   _this.PondX = _this.fish_1.x;
                   _this.PondY = _this.fish_1.y;
...
{ 
        ...
        _this.initial_flying.x = _this.KFsitting.x;
        _this.initial_flying.y = _this.KFsitting.y+25;
        _this.KFsitting.destroy();
        _this.initialTween3 = _this.add.tween(_this.initial_flying);
        //_this.initialTween3.onComplete.add(_this.Initiate_Game_Fn);
    ...
    Q4_clearObject: function(){
            ...
            if(_this.Q4_Options == 1)
             { 
               _this.KF_fadeOut1 = _this.add.tween(_this.KFsitting).to( { alpha: 0 }, 2000, 'Linear', true, 0);
             ...
             { 
              ...
              _this.KF_fadeOut2= _this.add.tween(_this.KF_Eatingfish).to( { alpha: 0 }, 2000, 'Linear', true, 0);
    ...
    Q4_gotonext: function(){
        ...
        else
        {
            ...
            _this.timer1.stop();
            _this.timer1=null;
            _this.state.start('numbers_int_4_g6Score');
    ...
    getVoice:function()
    {
        ...
        switch(_this.Q4_Options)
        {
            case 1: _this.src.setAttribute("src", "questionSounds/numbers_int_4_g6/English/place_the_bird_in.mp3");
                    break;
            case 2: _this.src.setAttribute("src", "questionSounds/numbers_int_4_g6/English/place_the_fish_in.mp3");
                        break; 
