Game.numbers_int_2_g6l1 = function () {};

Game.numbers_int_2_g6l1.prototype = {
    ...
    create: function (game) {
        ...
        _this.time.events.add(3000, _this.getQuestion);

    },

    displayNumbers: function() {
    // display the numbers with a delay, one by one.
        

        _this.time.events.add(500, function() { _this.Numbr_1 = _this.add.image(580, 220, 'Numbr_1');} );
        _this.time.events.add(750, function() { _this.Numbr_2 = _this.add.image(640, 190, 'Numbr_2');} );
        _this.time.events.add(1000, function() { _this.Numbr_3 = _this.add.image(720, 160, 'Numbr_3');} );
        _this.time.events.add(1250, function() { _this.Numbr_4 = _this.add.image(800, 130, 'Numbr_4');} );
        _this.time.events.add(1500, function() { _this.Numbr_5 = _this.add.image(870, 100, 'Numbr_5');} );
    ...
    Q2_showanswerActions: function (correct_answer) {
        ...
        if (correct_answer == true) {
            ...
            _this.time.events.add(4500, _this.Q2_gotonext);
        } else {
    ...
    Q2_gotonext: function () {
        ...
        if (_this.repeat1 < 6) {
            ...
            _this.timer1.stop();
            _this.timer1 = null;
            _this.state.start('numbers_int_2_g6Score');
   ...
   Q2_EnableVoice: function () {
    ...
    Q2_askVoiceQuestionProcess: function () {
        ...
        _this.time.events.add(1500, _this.getVoice2);
    ...
    getVoice: function () {
        ...
        _this.genTextsrc.setAttribute("src", "questionSounds/numbers_int_2_g6/English/which level is the.mp3");
    ...
    getVoice2: function () {
        ...
        if (_this.Q1_Option == 1) {
            _this.src.setAttribute("src", "questionSounds/numbers_int_2_g6/English/ball in.mp3");

        } else if (_this.Q1_Option == 2) {
            _this.src.setAttribute("src", "questionSounds/numbers_int_2_g6/English/cat in.mp3");

        } else if (_this.Q1_Option == 3) {
            _this.src.setAttribute("src", "questionSounds/numbers_int_2_g6/English/dog in.mp3");

        } else if (_this.Q1_Option == 4) {
            _this.src.setAttribute("src", "questionSounds/numbers_int_2_g6/English/rabbit in.mp3");

        } else if (_this.Q1_Option == 5) {
            _this.src.setAttribute("src", "questionSounds/numbers_int_2_g6/English/cloth in.mp3");
