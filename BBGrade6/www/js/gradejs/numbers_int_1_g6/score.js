Game.numbers_int_1_g6Score=function(game){

};

Game.numbers_int_1_g6Score.prototype={
	create:function(game){
		
        console.log("inside score js Q1" );
		_this = this;
		...
		_this.nextBtn.events.onInputDown.add(function()
		{
            ...
            _this.clickSound.play();
			//_this.cache.destroy();
console.log('Going to start the Question 2');
			_this.state.start('preloader_int_2',true,false); 
		},_this);
        ...
        _this.replay.events.onInputDown.add(function(){ 
            ...
            //_this.clickSound = _this.add.audio('ClickSound');
            //_this.clickSound.play();
            _this.state.start('numbers_int_1_g6l1',true,false);
         },_this);
